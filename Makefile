...
PROJECT_NAME ?= provider-permitio
...
export TERRAFORM_PROVIDER_SOURCE ?= permitio/permit-io
export TERRAFORM_PROVIDER_REPO ?= https://github.com/permitio/terraform-provider-permit-io
export TERRAFORM_PROVIDER_VERSION ?= 0.0.12
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-permit-io
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-permit-io_v0.0.12
...
xpkg.build.provider-permitio: do.build.images
